...
export class MultipleChoiceQuestionComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.question.multipleAnswers = [new MultipleAnswerDto(uuid(), true), new MultipleAnswerDto(uuid(), false), new MultipleAnswerDto(uuid(), false)];
  ...
  public changeValueOfAnswer(event: any, answerId: string): void {
    this.question.multipleAnswers.forEach(answer => {
      answer.value = false;
      if (event.checked && answer.id == answerId) answer.value = true;
    });
  }
